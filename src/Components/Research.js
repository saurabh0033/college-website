...
import SwiperCore, { Navigation, Pagination, Scrollbar, A11y, EffectFade,EffectCoverflow, Autoplay } from 'swiper';
...
SwiperCore.use([Navigation, Pagination, Scrollbar, A11y, EffectFade,EffectCoverflow, Autoplay]);
const data = [
    {
        id: 1,
        image: { Image1 },
